...
export default function AcceptationModal(props: Props) {
    return (
        <Modal open={props.open} onClose={props.onClose}>
            ...
            <div className="p-6 text-center">
                ...
                <div className={'flex justify-center gap-x-4'}>
                    <RedButton onClick={() => props.onReject?.()}>I refuse</RedButton>
                    <WhiteButton onClick={() => props.onConfirm?.()}>I accept</WhiteButton>
                </div>
            </div>
        </Modal>
    );
